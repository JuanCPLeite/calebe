...
import { Upload, X, ImageIcon, Loader2, Plus, ArrowLeft } from 'lucide-react'
...
export default function PhotosPage() {
  ...
  async function openExpert(nextExpertId: string) {
        ...
        <>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">Selecione um expert para abrir as fotos de referência</p>
            </div>
            <button
              onClick={() => setShowExpertModal(true)}
              className="inline-flex items-center gap-2 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-zinc-200 text-sm font-medium px-4 py-2 rounded-lg transition-colors"
              title="Selecionar expert"
            >
          ...
          <div className="mb-6 rounded-xl border border-zinc-800 bg-zinc-900/40 p-4 space-y-3">
            <div>
              ...
              <p className="text-xs text-zinc-500">Clique em um expert para gerenciar as fotos de referência</p>
            </div>
            ...
            >
              ...
              >
                <div className="flex items-center justify-between">
                  <p className="text-sm font-semibold text-zinc-100">Experts cadastrados no DNA</p>
                ...
                <div className="space-y-2 max-h-[50vh] overflow-y-auto">
                  ...
                  {experts.length === 0 && (
                    <p className="text-xs text-zinc-500">Nenhum expert cadastrado no DNA ainda.</p>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">
                Até 10 fotos do expert selecionado — usadas para gerar imagens com você no fundo
              </p>
